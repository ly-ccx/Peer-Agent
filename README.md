...
> [!NOTE]
> Current stable release: **`0.0.3`** (npm `latest`), beta channel **`0.0.4-beta.4`**. Desktop, TUI/CLI, Agent/Plan/Goal workflows, Automation, MCP, Skills, and the Open Runtime are available today — see [Roadmap](#-roadmap).
