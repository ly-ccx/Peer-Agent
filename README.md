...
> [!NOTE]
> Current stable release: **`0.0.12`** (npm `latest`); latest published beta channel **`0.0.5-beta.4`**. Desktop, TUI/CLI, Agent/Plan/Goal workflows, Automation, MCP, Skills, and the Open Runtime are available today — see [Roadmap](#-roadmap).
