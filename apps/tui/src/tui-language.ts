...
const MESSAGES: Readonly<Record<TuiLocale, Readonly<Record<TuiMessageKey, string>>>> = Object.freeze({
  'zh-CN': {
    ...
    'command.new.label': '新任务',
    'command.new.description': '开启全新空任务并回到首页',
  ...
  'en-US': {
    ...
    'command.new.label': 'New task',
    'command.new.description': 'Start a fresh empty task and return to the home screen',
