...
export function SkillDetailDialog({
  ...
  return (
    <div className="skill-detail-overlay" role="presentation" onMouseDown={(event) => {
      ...
      <section className="skill-detail-dialog" role="dialog" aria-modal="true" aria-labelledby="skill-detail-title">
        <header className="skill-detail-header">
          ...
          <button type="button" className="skill-detail-close" aria-label="关闭" onClick={onClose}>×</button>
        </header>
