...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  skillhub_detail_identity_mismatch: 'SkillHub 详情与所选技能坐标不一致，已阻止安装',
  skillhub_signature_publisher_mismatch: '签名发布者与 SkillHub 详情中的技能所有者不一致，已阻止安装',
  skillhub_signature_coordinate_mismatch: '签名中的技能名称或版本与所选技能不一致，已阻止安装',
  skillhub_invalid_detail_namespace: 'SkillHub 详情缺少有效命名空间，无法验证安装身份',
  skillhub_invalid_detail_slug: 'SkillHub 详情缺少有效技能名称，无法验证安装身份',
  skillhub_invalid_detail_owner: 'SkillHub 详情缺少有效发布者身份，无法验证安装签名',
