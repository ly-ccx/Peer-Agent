...
const unavailableApi: ClientApi = {
  ...
  modelRoutingGet: unavailableMethod('modelRoutingGet'),
  modelRoutingUpdate: unavailableMethod('modelRoutingUpdate'),
  modelRoutingPreview: unavailableMethod('modelRoutingPreview'),
  ...
  selectionQuote: unavailableMethod('selectionQuote'),
  selectionCreateChild: unavailableMethod('selectionCreateChild'),
  selectionListChildren: unavailableMethod('selectionListChildren'),
  selectionReadChild: unavailableMethod('selectionReadChild'),
  selectionSaveDraft: unavailableMethod('selectionSaveDraft'),
  ...
  getRemoteAccess: unavailableMethod('getRemoteAccess'),
  updateRemoteAccess: unavailableMethod('updateRemoteAccess'),
  applyRemoteAccess: unavailableMethod('applyRemoteAccess'),
