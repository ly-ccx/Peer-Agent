...
contextBridge.exposeInMainWorld('peerAgent', {
  ...
  workspaceUpdate: (params) => ipcRenderer.invoke('workspace:update', params),
  workspaceAddLinkedFolder: (params) => ipcRenderer.invoke('workspace:add-linked-folder', params),
  workspaceRemoveLinkedFolder: (params) => ipcRenderer.invoke('workspace:remove-linked-folder', params),
  workspaceSetPrimary: (params) => ipcRenderer.invoke('workspace:set-primary', params),
  ...
  modelRoutingGet: () => ipcRenderer.invoke('model-routing:get'),
  modelRoutingUpdate: (partial) => ipcRenderer.invoke('model-routing:update', partial),
  modelRoutingPreview: () => ipcRenderer.invoke('model-routing:preview'),
  ...
  conversationsUpdateFastMode: (params) => ipcRenderer.invoke('conversations:update-fast-mode', params),
  conversationsUpdatePreferredExecutionIsolation: (params) =>
    ipcRenderer.invoke('conversations:update-preferred-execution-isolation', params),
  ...
  goalPlansInspectSourceCheckout: (params) => ipcRenderer.invoke('goalPlans:inspect-source-checkout', params),
  ...
  onChatStreamPermissionSettled: (listener) => {
    const handler = (_event, payload) => listener(payload);
    ipcRenderer.on('chat:stream:permission-settled', handler);
    return () => ipcRenderer.removeListener('chat:stream:permission-settled', handler);
  },
