...
const AGENT_SELF_DRIVEN_COPY = [
  ...
  'L1 Micro-plan: small low-risk edits (about 1–2 files, clear scope) — keep a short 3–6 step plan in the turn; formal GoalPlan optional.',
  'L2 Auto Goal: multi-step feature/fix/cross-file work — before the first side-effecting action, establish a formal GoalPlan with goal_create_plan (no approval wait). If a plan already exists, re-read it with goal_get_plan and continue; do not invent taskIds or report progress outside goal_update_task.',
