 ...
 * @param {Record<string, any> & { fetchImpl: Function }} options
 * @returns {Promise<{ inputTokens: number, source: 'provider_count_api' }>}
 */
export async function countAnthropicCanonicalRequest({
  ...
  if (typeof fetchImpl !== 'function') {
    throw new TypeError('countAnthropicCanonicalRequest requires a fetchImpl host port');
  }
...
export async function countGeminiCanonicalRequest({
  ...
  if (typeof fetchImpl !== 'function') {
    throw new TypeError('countGeminiCanonicalRequest requires a fetchImpl host port');
  }
